...
// 从comment.js 中导入需要的函数调用后端接口
import { getCommentList, getCommentListByUserId,getCommentDetail,addOrUpdateComment,getCommentListByUp ,deleteComment} from '@/api/comment'
